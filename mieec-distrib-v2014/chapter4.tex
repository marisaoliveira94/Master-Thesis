...
\begin{figure}[h!]
	\begin{center}
		\leavevmode
		\includegraphics[width=0.75\textwidth]{tx_gtx_arq}
...
\begin{figure}[h!]
	\begin{center}
		\leavevmode
		\includegraphics[width=0.9\textwidth]{rx_gtx_arq}
...
\subsection{Alinhamento de Palavras}
...
%%Alinhamento Manual
Este bloco possibilita ainda um alinhamento manual das palavras movendo os dados em paralelo m
