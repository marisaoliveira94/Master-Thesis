...
\begin{table}[h!]
			...
			\centering
					\caption[Nomes dos pinos da interface FMC de TB-FMCH-HDMI2 RX]{Nomes dos pins da interface FMC de TB-FMCH-HDMI2 RX (adaptada de \cite{R009})}
...
Existe ainda um bloco que é comum tanto ao serializador como ao deserializador que é o \textbf{\textit{Clock Manager}} que essencialmente é responsável pelos diversos processos que os sinais de relógio necessitarão: desde multiplicações de frequências, divisões e até mesmo recuperação do mesmo.
...
O autor de \cite{R012} propõe 3 tipos de arquiteturas para este tipo de bloco que são apresentadas na figura \ref{fig:PISO-SIPO} e que passam a ser descritas as suas vantagens e desvantagens.
