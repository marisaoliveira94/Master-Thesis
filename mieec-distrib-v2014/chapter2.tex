...
Os sinais representados na tabela~\ref{table:HDMIdataTX} na página~\pageref{table:HDMIdataTX} são equivalentes aos sinais presentes na tabela~\ref{table:HDMIdataRX} na página~\pageref{table:HDMIdataRX}, mis uma vez com a placa configurada por \textit{default}.
	
Os dados capturados pela FPGA embebida na placa na transição de 0 para 1 do sinal de relógio do vídeo, tal como ilustra a figura~\ref{fig:HDMIamostragemTX} na página~\pageref{fig:HDMIamostragemTX}. Como tal, o sinal deve ser transferido na FPGA principal transição de 1 para 0 do sinal de relógio do vídeo. 
...
\subsection{Considerações sobre as características dos dados em série}
