...
Para gerar uma imagem em \textit{FULL HD} cuja resolução é 1920x1080 pixeis e o sinal de relógio deve ter uma frequência de 148.5 MHz, foram o utilizados os seguintes valores para os parâmetro previamente descritos:
\begin{itemize}
	\item HRES = 1920
	\item HSW = 44
	\item HBP = 44
...
\begin{itemize}
	...
	\item \textbf{Sinal de dados ativos:} Este sinal deve estar ativo sempre que se estiver a transmitir os valores de cada pixel, e por isso deve estar ativo sempre que as quatro condições que serão de seguida apresentadas se verificarem:
	
	e por isso esse motivo este sinal deve ser ligado sempre que o valor de HCOUNT for maior do a soma entre HSW e HBP subtraído de 1 valor e ao mesmo tempo for menor do que a soma entre HRES, HBP e HSW. Deve estar ativo entre entes valores, por que
	\item \textbf{Valor dos pixeis}
\end{itemize}
